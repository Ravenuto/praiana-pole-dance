...
import {
  ...
  Home, CalendarDays, Bookmark, Megaphone, ImageIcon, CreditCard, User, ShieldCheck
} from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            <img
              src="https://media.base44.com/images/public/6a0b29752977eaee21c7da55/943b83331_5.png"
              alt="Praiana"
