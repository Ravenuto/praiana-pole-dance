      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-32 relative">
          <motion.div
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">Seja muito bem vinda ao nosso estúdio! Marque as suas aulas de forma rápida e prática no nosso app
